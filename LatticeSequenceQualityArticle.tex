...
For positive integer $\alpha$, we may again appeal to Bernoulli polynomials as we did in \eqref{eq:P2alpha}: \LarysaNote{correct equation?}
\begin{align*}
\nonumber
...
\end{align*}
where $\tilde{\gamma}_{\ell}$ was defined in \eqref{eq:gammatilde}.
